...
//				'joins'=>$this->Listing->joinsReviews
    ...
    {         
       ...
       $is_duplicate = false;
		...
		if ( $this->data['Criteria']['state'] == 1 ) //ratings enabled
		{
...
/**********************************************************
* All deprecated methods requiring xajax below this point    
***********************************************************/  
    function _vote() 
    {
        ...
        $data = array('Vote'=>array(
            ...
            'vote_yes'=>$this->data['action'] ? 1 : 0,
            'vote_no'=>$this->data['action'] ? 0 : 1
        ));
        $Votes->data = $data;
