...
class EverywhereComJoomgalleryModel extends MyModel  {
	...
	var $listingUrl = 'index.php?option=com_joomgallery&amp;func=detail&amp;id=%s&amp;Itemid=%s';
	...
	function afterFind($results) {
		...
		foreach($results AS $key=>$result) {
			...
			if($images != '') {
				if ( @file_exists("components/com_joomgallery/img_pictures/".$result['Listing']['images_path'] . '/' . $images) ) {
				    $imagePath = "components/com_joomgallery/img_pictures/".$result['Listing']['images_path'] . '/' . $images;
				}
			} else {
