...
S2Paths::set($s2_app, 'S2_APP_URL', WWW_ROOT . 'components'. _DS . 'com_'.$s2_app . _DS . $s2_app . _DS);	
...
{
    if(!defined('_JR_WWW_IMAGES')) define('_JR_WWW_IMAGES','images' . _DS . 'stories' . _DS); 
    if(!defined('_JR_PATH_IMAGES')) define('_JR_PATH_IMAGES','images' . DS . 'stories' . DS); 
}
