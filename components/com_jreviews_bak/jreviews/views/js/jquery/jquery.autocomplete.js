jQuery.autocomplete = function(input, options) {
    ...
    // Create results
    if(options.multipleInstances == false){
        jQuery('.'+options.resultsClass).remove(); // Alejandro to avoid having multiple result divs appended to the body of the page
    }
...
jQuery.fn.autocomplete = function(url, options, data) {
    ...
    options = jQuery.extend({
        ...
        autoFill: false,
        width: 0,
        multipleInstances: false /*Alejandro*/
    }, options);
