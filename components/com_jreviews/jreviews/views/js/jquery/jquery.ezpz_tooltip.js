...
(function($){
    ...
    $.fn.ezpz_tooltip.positions.bottomLeft = function(contentInfo, mouseX, mouseY, offset, targetInfo) 
    {
        contentInfo['top'] = targetInfo['top'] + targetInfo['height'] + offset;
        contentInfo['left'] = (targetInfo['left'] + (targetInfo['width'] / 2)) - contentInfo['width']/1.1;
        return contentInfo;
    };	
