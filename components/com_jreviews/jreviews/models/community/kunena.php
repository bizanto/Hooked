...
class CommunityModel extends MyModel  {
    ...
    var $useTable = '#__fb_users AS Community';
    ...
    function addProfileInfo($results, $modelName, $userKey)
    {
        ...
        foreach ($profiles AS $key=>$value) {    
            ...
            $avatar_image = $profiles[$value[$this->name][$userKey]][$this->name]['avatar'] != '' ? $profiles[$value[$this->name][$userKey]][$this->name]['avatar'] : 'nophoto.jpg';
            $profiles[$value[$this->name][$userKey]][$this->name]['avatar_path'] = WWW_ROOT. 'images' . _DS . 'fbfiles' . _DS . 'avatars' . _DS . $avatar_image;
        }
