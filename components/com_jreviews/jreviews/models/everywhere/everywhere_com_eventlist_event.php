...
class EverywhereComEventlistEventModel extends MyModel  {
	...
	var $fields = array(
		...
		'Listing.catsid AS `Listing.cat_id`',
	...
	var $joins = array(
		...
		"LEFT JOIN #__eventlist_categories AS Category ON Listing.catsid = Category.id",
		"INNER JOIN #__jreviews_categories AS JreviewsCategory ON Listing.catsid = JreviewsCategory.id AND JreviewsCategory.`option` = 'com_eventlist_event'",
	...
	var $joinsReviews = array(
		...
		"INNER JOIN #__jreviews_categories AS JreviewsCategory ON Listing.catsid = JreviewsCategory.id AND JreviewsCategory.`option` = 'com_eventlist_event'",
		"LEFT JOIN #__eventlist_categories AS Category ON Category.id = Listing.catsid",
		'LEFT JOIN #__jreviews_criteria AS Criteria ON JreviewsCategory.criteriaid = Criteria.id'
	);
