...
<h3><?php echo JText::_('CC ACTIVITES CUSTOM MESSAGES' );?></h3>
<div class="joms-form-row">
	...
	<div class="joms-form-row-right">
		<label for="custom-predefined-message"><?php echo JText::_('CC SELECT PREDEFINED MESSAGES');?></label>
...
<div class="joms-form-row">
	...
	<div class="joms-form-row-right">
		<label for="custom-text-message"><?php echo JText::_('CC WRITE A CUSTOM MESSAGE');?></label>
...
<div class="joms-form-row">
	...
	<div class="joms-form-row-right">
		<label>
			<input type="button" name="button" id="button" value="<?php echo JText::_('CC POST IT');?>" onclick="joms.activities.addCustom()" />
		</label>
	</div>
</div>
</form>
