...
<div class="cLayout clrfix">
				...
				<ul class="group-menus cResetList clrfix">
					...
					<?php if( $allowCreateEvent && $config->get('group_events') && $config->get('enableevents') ) { ?>
					    <li>
						    ...
						    <?php echo JText::_('CC GROUP CREATE EVENT');?>
						    </a>
					    </li>
					<?php } ?>
		...
		<?php if( $group->approvals=='0' || $isMine || ($isMember && !$isBanned) || $isCommunityAdmin ) { ?>
			...
			<div id="community-group-side-events" class="cModule">
					<h3><?php echo JText::_('CC EVENTS');?></h3>
					<div class="app-box-content">
						<div id="community-group-container">
							<?php if( $events ) { ?>
								<ul class="cResetList">
    ...
    <div class="cMain clrfix">
			...
			<div id="groups-invite-<?php echo $group->id; ?>" class="com-invitation-msg">
				...
				<?php echo JText::sprintf( 'CC GROUPS YOU ARE INVITED', $join); ?><br />

				<?php echo JText::sprintf( (CStringHelper::isPlural($friendsCount)) ? 'CC GROUPS FRIEND' : 'CC GROUPS FRIEND MANY', $friendsCount ); ?>
				</div>
			...
			<div class="group-top">
				...
				<div class="group-desc">
						<div class="ctitle"><h2><?php echo JText::_('CC GROUP INFO DESCRIPTION');?></h2></div>
