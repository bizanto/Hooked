...
<table class="formtable">
	...
	<tr>
		<td class="key">
			<label for="lock" class="label">*<?php echo JText::_('CC LOCK DISCUSSION'); ?></label>
		</td>
		<td class="value">  
			<div>
				<input type="radio" name="lock" id="lock-yes" value="1"<?php echo ($discussion->lock == true ) ? ' checked="checked"' : '';?> />
				<label for="lock-yes" class="label lblradio"><?php echo JText::_('CC YES');?></label>
			</div>
			<div>
				<input type="radio" name="lock" id="lock-no" value="0"<?php echo ($discussion->lock == false ) ? ' checked="checked"' : '';?> />
				<label for="lock-no" class="label lblradio"><?php echo JText::_('CC NO');?></label>
			</div>	
		</td>
	</tr>
