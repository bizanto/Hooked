...
<ul class="jsTogSearch">
	<li>
		...
		<form name="jsform-search" method="get" action="<?php echo $url; ?>">
			...
			<label class="lblradio"><input type="checkbox" name="avatar" style="margin-right: 5px;" value="1" class="radio"><?php echo JText::_("CC AVATAR ONLY"); ?></label>
			...
			<input type="submit" value="<?php echo JText::_('CC SEARCH'); ?>">
		</form>
		</div>
	</li>
</ul>