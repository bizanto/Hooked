...
<div class="cToolbarBand">
	<div class="bandContent">
		...
		{
		?>
		<div class="jomTips" style="float: left;" id="<?php echo "video-" . $video->getId() ?>" title="<?php echo $video->getTitle() . '::' . $video->getDescription(); ?>">
			<div class="video-thumb">
				<a class="video-thumb-url" href="<?php echo $video->getURL(); ?>" style="width: <?php echo $videoThumbWidth; ?>px; height:<?php echo $videoThumbHeight; ?>px;"><img src="<?php echo $video->getThumbnail(); ?>" alt="<?php echo $video->getTitle();?>"/></a>
