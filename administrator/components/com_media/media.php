...
define('COM_MEDIA_BASE',    JPath::clean(JPATH_ROOT.DS.$params->get($path, 'images'.DS.'photos'.DS.$userId)));
define('COM_MEDIA_BASEURL', JURI::root().$params->get($path, 'images/photos'));
