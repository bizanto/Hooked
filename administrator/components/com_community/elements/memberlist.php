...
class JElementMemberlist extends JElement
{
	...
	function fetchElement($name, $value, &$node, $control_name)
	{
		...
		{
			$memberlist->title = JText::_('CC SELECT A MEMBERLIST');
		}
		...
		$html .= '<div class="button2-left"><div class="blank"><a class="modal" title="'.JText::_('CC SELECT A MEMBERLIST').'"  href="'.$link.'" rel="{handler: \'iframe\', size: {x: 650, y: 375}}">'.JText::_('Select').'</a></div></div>'."\n";
