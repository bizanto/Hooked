	...
	<tbody>
		...
		<tr>
			...
			<td align="left">
				...
				{
				?>
				<div><?php echo JText::_('You need members to be in the group before you are allowed to change group owner');?></div>
				<?php
				}
				?>
			</td>
