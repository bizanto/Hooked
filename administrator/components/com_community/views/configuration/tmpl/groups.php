...
<fieldset class="adminform">
	<legend><?php echo JText::_( 'CC GROUPS' ); ?></legend>
	<table class="admintable" cellspacing="1">
		<tbody>
			...
			<tr>
				<td width="350" class="key">
					<span class="hasTip" title="<?php echo JText::_( 'CC ENABLE GROUPS SEARCH' ); ?>::<?php echo JText::_('CC ENABLE GROUPS SEARCH TIPS'); ?>">
						<?php echo JText::_( 'CC ENABLE GROUPS SEARCH' ); ?>
					</span>
				</td>
				<td valign="top">
					<?php echo JHTML::_('select.booleanlist' , 'enableguestsearchgroups' , null , $this->config->get('enableguestsearchgroups') , JText::_('CC YES') , JText::_('CC NO') ); ?>
				</td>
			</tr>
			<tr>
				<td class="key">
			...
			<tr>
				<td class="key">
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'CC GROUP DISCUSSIONS ORDER' ); ?>::<?php echo JText::_('CC GROUP DISCUSSIONS ORDER TIPS'); ?>">
						<?php echo JText::_( 'CC GROUP DISCUSSIONS ORDER' ); ?>
					</span>
				</td>
				<td valign="top">
			...
			<tr>
				<td class="key">
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'CC ENABLE GROUP EVENTS' ); ?>::<?php echo JText::_('CC ENABLE GROUP EVENTS TIPS'); ?>">
						<?php echo JText::_( 'CC ENABLE GROUP EVENTS' ); ?>
					</span>
				</td>
				<td valign="top">
					<?php echo JHTML::_('select.booleanlist' , 'group_events' , null , $this->config->get('group_events') , JText::_('CC YES') , JText::_('CC NO') ); ?>
				</td>
			</tr>
			<tr>
				<td class="key">
