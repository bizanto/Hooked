...
<fieldset class="adminform">
	...
	<table class="admintable" cellspacing="1">
		<tbody>
			...
			<tr>
				<td width="300" class="key">
					<span class="hasTip" title="<?php echo JText::_( 'CC RECAPTCHA SECURE MODE' ); ?>::<?php echo JText::_('CC RECAPTCHA SECURE MODE TIPS'); ?>">
						<?php echo JText::_( 'CC RECAPTCHA SECURE MODE' ); ?>
					</span>
				</td>
				<td valign="top">
					<?php echo JHTML::_('select.booleanlist' , 'recaptcha_secure' , null , $this->config->get('recaptcha_secure') , JText::_('CC YES') , JText::_('CC NO') ); ?>
				</td>
			</tr>
			<tr>
				<td width="300" class="key">
			...
			<tr>
				<td width="300" class="key">
					<span class="hasTip" title="<?php echo JText::_( 'CC ALLOW PROFILE DELETION' ); ?>::<?php echo JText::_('CC PROFILE DELETION TIPS'); ?>">
						<?php echo JText::_( 'CC ALLOW PROFILE DELETION' ); ?>
					</span>
				</td>
				<td valign="top">
					<?php echo JHTML::_('select.booleanlist' , 'profile_deletion' , null , $this->config->get('profile_deletion') , JText::_('CC YES') , JText::_('CC NO') ); ?>
				</td>
			</tr>
			<tr>
				<td width="300" class="key">
			...
			<tr>
				...
				<td valign="top">
					<select name="recaptchalang">
						...
						<option value="it"<?php echo $this->config->get('recaptchalang') == 'it' ? ' selected="selected"' : ''; ?>><?php echo JText::_('CC ITALIAN');?></option>
					</select>
				</td>
			</tr>
		</tbody>
