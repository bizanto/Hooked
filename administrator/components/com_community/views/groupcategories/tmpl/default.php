...
function submitbutton(action)
{
	...
	<table class="adminlist" cellspacing="1">
		<thead>
			<tr class="title">
				<th width="1%"><?php echo JText::_('CC NUMBER'); ?></th>
				...
				<th width="5%">
					<?php echo JHTML::_('grid.sort',   JText::_('CC MEMBER S'), 'members', $this->lists['order_Dir'], $this->lists['order'] ); ?>
				</th>
				<th width="2%">
