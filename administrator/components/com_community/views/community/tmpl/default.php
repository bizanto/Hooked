	...
	<tr>
		<td width="55%" valign="top">
			<div id="cpanel">
				...
				<?php echo $this->addIcon('multiprofile.gif','index.php?option=com_community&view=multiprofile', JText::_('CC MULTIPLE PROFILES'));?>
				...
				<?php echo $this->addIcon('memberlist.gif','index.php?option=com_community&view=memberlist', JText::_('CC MEMBERLIST')); ?>
