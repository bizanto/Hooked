...
function submitbutton(pressbutton)
		{
			...
			var answer = confirm( "<?php echo JText::_('Are you sure?', true); ?>" );
				if (answer)
				{
				...
				{
					alert( "<?php echo JText::_('Nothing done your safe :)', true); ?>" );					
				}
		}
</script>
...
<div id="editcell">
	...
	for ($i=0, $n=count( $this->items ); $i < $n; $i++)
	{
		...
		$friends		= JRoute::_( 'index.php?option=com_friendmanager&view=friends&uid='. $row->connect_from );
		?>
		<tr class="<?php echo "row$k"; ?>">
			...
			<td>
				<a href="<?php echo $link; ?>"><?php echo $from; ?></a><a href="<?php echo $friends; ?>"><?php echo " - Friends"; ?></a>
			</td>
			<td>
