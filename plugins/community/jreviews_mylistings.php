...
class plgCommunityJreviews_mylistings extends CApplications
{
    ...
    function plgCommunityJreviews_mylistings(& $subject, $config)
    {
    ...
    function onProfileDisplay()
    {
        if( !file_exists( $this->_path . DS . 'admin.jreviews.php' ) ){
            ...
            $callback = array('plgCommunityJreviews_mylistings', '_getPage');
