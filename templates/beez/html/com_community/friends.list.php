...
<div id="friend-<?php echo $user->id; ?>" class="mini-profile jsFriendList">
	<?php if( $isMine ): ?>
	<div class="jsRel jsFriendRespond fr">
    	<input type="submit" class="button" style="margin:0" onclick="joms.friends.confirmFriendRemoval(<?php echo $user->id; ?>);" value="<?php echo JText::_('CC REMOVE FRIEND'); ?>" />
	</div>
	<?php endif; ?>
	...
	<div class="mini-profile-details-action jsRel jsFriendAction">
