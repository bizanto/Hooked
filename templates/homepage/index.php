...
if ($active == $default) $isHome=1; else $isHome="";
if (is_object( $active )) {
...
?>
    ...
    <meta property="og:title" content="HOOKED.no" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="<?php echo (JURI::getInstance()->toString()); ?>" />
    <meta property="og:image" content="http://www.hooked.no/hooked.png" />
...
jQuery(function ($) {
	...
	$('.mailfriend').click(function() {
		...
		$(this).parent().siblings('.mail_this_page').toggleClass('hide');
		return false;
    });	
	$('#cancelfriend').click(function() {
		$(this).parent().parent().parent().parent().siblings('.article-likes').children('.mailfriend').toggleClass('hide');
...
<script type="text/javascript">var switchTo5x=true;</script><script type="text/javascript" src="http://w.sharethis.com/button/buttons.js"></script><script type="text/javascript">stLight.options({publisher:'6986eb03-8e4c-45f0-a67d-69d288cb188d'});</script>
<?php endif; ?>
...
<body<?php if ($isHome) echo ' id="homepage"'; echo ' class="body'; if ($registration_page) echo ' simple'; if ($pageclass) echo ' '.$pageclass.''; echo '"'; ?><?php if ($iMobile) echo ' style="-webkit-text-size-adjust:none"'; ?>>
            ...
            <div id="main-container-wrap-outer">
                ...
                <div id="main-container-wrap">
                    <div class="stitches-right">
                        <div id="main-container-bg">
                            <div id="main-container-top">
                                <div id="main-container">
                                    ...
                                    <?php else : ?>
                                        <?php if ($this->countModules('home-main')) : ?>
                                        <div class="home-main">
                                            <jdoc:include type="modules" name="home-main" style="xhtml" />
                                        </div>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                    </div>
                        ...
                        <div class="clear"></div>
                        <?php if (!$isHome && !$registration_page) : ?>
                        <div class="stitches-top"></div>
                        <div id="footer">
