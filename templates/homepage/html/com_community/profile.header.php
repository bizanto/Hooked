	    ...
	    <div class="profile-toolbox-br">
	        ...
	        <div class="profile-toolbox-tl">
				...
				<ul class="small-button">
					...
					<?php endif; ?>
                    <li>
                    	<a style="background: none;" href="/index.php?option=com_jreviews&Itemid=222&url=my-listings/user:<?php echo $profile->id; ?>/tmpl_suffix:_topcatches/cat:14">
                        	<span>Fangstrapporter</span>
                        </a>
                    </li>
                    <li>
                    	<a style="background: none;" href="/index.php?option=com_jreviews&Itemid=237&url=my-listings/user:<?php echo $profile->id; ?>/tmpl_suffix:_map_spots/section:1">
