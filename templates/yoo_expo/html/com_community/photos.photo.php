  	...
  	<div class="photoViewport">
    	...
    	<div class="vidSubmenu clrfix">
    		...
    		<ul class="submenu jsApSbMn">
    			<li><span><?php echo JText::_('CC VIDEO HITS') ?> <strong class="photoHitsText" id="photo-hits"><?php echo $default->hits; ?></strong></span></li>
...
<?php $locations = getMediaLocation(4); if ($locations||1) : ?>
		<textarea>lol: <?php echo $photo->id; var_dump($locations); ?></textarea>
    <?php endif; ?>