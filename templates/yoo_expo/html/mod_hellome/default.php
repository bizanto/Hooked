...
?>
	<div class="hello-container">
		...
		{
		?>
			<img src="<?php echo $myKarma; ?>" alt="<?php echo JText::_('MOD_HELLOME KARMA'); ?>" width="103" height="19" class="hello-karma" />
		<?php
		}
		?>

			<a class="new-msg" href="<?php echo CRoute::_('index.php?option=com_community&view=inbox'); ?>"><?php echo $unreadCount; ?></a>
			<a class="new-req" href="<?php echo CRoute::_('index.php?option=com_community&view=friends&task=pending'); ?>"><?php echo $pending; ?></a>
		...
		<a href="javascript:void(0);" id="saveLink" style="display: none; background: transparent url(<?php echo JURI::root(); ?>modules/mod_hellome/images/icons-16x16.gif) no-repeat 0 -440px;" onclick="helloMe.saveStatus();" class="icon-save"><?php echo JText::_('MOD_HELLOME SAVE MY STATUS'); ?></a>
		<a href="javascript:void(0);" id="editLink" style="display: block; background: transparent url(<?php echo JURI::root(); ?>modules/mod_hellome/images/icons-16x16.gif) no-repeat 0 -419px;" onclick="helloMe.changeStatus();" class="icon-edit"><?php echo JText::_('MOD_HELLOME EDIT MY STATUS'); ?></a>
		</div>
