...
#fpss-outer-container { z-index: 3; position: relative; margin: 0 auto;overflow:hidden;width:<?php echo $width; ?>px;} /* This element controls the slideshow spacing and border */
...
/* --- Navigation Buttons --- */
#navi-outer { position: absolute; bottom: 0; left: 0; z-index: 55; width: 100%; clear:both;margin:0;padding:0; background: url(/templates/beez/images/bg-trans-green.png) 0 0 repeat;  overflow:hidden;}
